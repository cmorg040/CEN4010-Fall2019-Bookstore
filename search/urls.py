...
urlpatterns = [
    ...
    path('browse-fantasy', views.browse_fantasy, name='browse-fantasy'),
    path('browse-fiction', views.browse_fiction, name='browse-fiction'),
    path('browse-nonfiction', views.browse_nonfiction, name='browse-nonfiction'),
    path('browse-mystery', views.browse_mystery, name='browse-mystery'),
    path('browse-romance', views.browse_romance, name='browse-romance'),
    path('browse-scifi', views.browse_top, name='browse-top'),
    path('browse-top', views.browse_scifi, name='browse-scifi'),
